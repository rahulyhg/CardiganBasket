...
if( !class_exists('FloatCartSettingsFramework') ){
    /**
     * FloatCartSettingsFramework class
     */
    class FloatCartSettingsFramework {
    	...
    	{
            global $mpfc_page_hook;
            $screen = get_current_screen();

            if ( $screen->id == 'product_page_mpt-floating-cart' )
                settings_errors();
    	}
    	...
    	/**
         * Displays the "section_description" if speicified in $floatcart_settings
         *
    	...
    	function section_intro( $args )
    	{
        	...
        	if(!empty($floatcart_settings)){
        		foreach($floatcart_settings as $section){
    	...
    	/**
         * Processes $floatcart_settings and adds the sections and fields via the WordPress settings API
         */
    	function process_settings()
    	{
            global $floatcart_settings;
        	if(!empty($floatcart_settings)){
        	    usort($floatcart_settings, array(&$this, 'sort_array'));
        		foreach($floatcart_settings as $section){
    	...
    	/**
         * Usort callback. Sorts $floatcart_settings by "section_order"
         * 
