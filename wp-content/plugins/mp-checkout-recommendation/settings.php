...
if( !class_exists('MPCRSettingsFramework') ){
    /**
     * MPCRSettingsFramework class
     */
    class MPCRSettingsFramework {
    	...
    	/**
         * Displays the "section_description" if speicified in $mpcr_settings
         *
    	...
    	function section_intro( $args )
    	{
        	...
        	if(!empty($mpcr_settings)){
        		foreach($mpcr_settings as $section){
    	...
    	/**
         * Processes $mpcr_settings and adds the sections and fields via the WordPress settings API
         */
    	function process_settings()
    	{
            global $mpcr_settings;
        	if(!empty($mpcr_settings)){
        	    usort($mpcr_settings, array(&$this, 'sort_array'));
        		foreach($mpcr_settings as $section){
    	...
    	/**
         * Usort callback. Sorts $mpcr_settings by "section_order"
         * 
        ...
        function settings()
        {
            if ( isset( $_GET['settings-updated'] ) && $_GET['settings-updated'] === 'true' )
                $updated = '<span class="settings-updated" style="color: #51a351; margin-left: 10px;">' . __( 'Updated!', 'mpcr' ) . '</span>';
            else 
                $updated = '';
            ...
            <form action="options.php" method="post">
        		...
        		<p class="submit"><input type="submit" class="button-primary" value="<?php _e( 'Save Changes' , 'mpcr' ); ?>" /><?php echo $updated; ?></p>
			</form>
    		<?php
