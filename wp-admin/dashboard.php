...
function wp_welcome_panel() {
	...
	<h3><?php _e( 'Understanding the Back-End tools to your new site' ); ?></h3>
	<p class="about-description"><?php _e( 'Here are some tutorials to help you with setting up your shop' ); ?></p>
