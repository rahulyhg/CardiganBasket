...
<?php
				...
				$editProfileFilterArray2['contentName1'] = '<p class="nameHeader"><strong>'. __('Change Email', 'profilebuilder') .'</strong></p>';
				...
				$editProfileFilterArray2['contentInfo1'] = '<p class="contactInfoHeader"><strong>'. __('', 'profilebuilder') .'</strong></p>';
				...
				$editProfileFilterArray2['aboutYourself1'] = '<p class="aboutYourselfHeader"><strong>'. __('Change Password', 'profilebuilder') .'</strong></p>';
